...
class StoreHistorialClinicoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'enfermedades_base' => ['nullable', 'string'],
            'motivo_apertura' => ['required', 'string'],
            'fecha_apertura' => ['required', 'date'],
            'fecha_actualizacion' => ['nullable', 'date'],
            'observaciones_generales' => ['nullable', 'string'],
            'estado' => ['sometimes', 'required', 'string', 'in:ACTIVO,INACTIVO,activo,inactivo'],
            'paciente_ci' => ['required', 'exists:pacientes,codigo_paciente', 'unique:historiales_clinicos,paciente_ci'],
