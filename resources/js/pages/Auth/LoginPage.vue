...
<template>
    ...
    <main
        class="min-h-screen px-6 py-10 text-[var(--text)] transition-colors duration-300"
        ...
        <section class="mx-auto flex min-h-[calc(100vh-80px)] max-w-6xl items-center justify-center">
            ...
            >
                <div class="relative hidden min-h-[650px] overflow-hidden bg-[var(--primary)] p-10 text-white md:block">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-[#006f68]/90 via-[#00a99d]/70 to-[#18dccf]/45"></div>
                    ...
                    <div class="relative z-10 flex h-full flex-col justify-between">
                        ...
                        <div>
                            <span class="mb-5 inline-flex rounded-full bg-white/20 px-5 py-2 text-sm font-bold backdrop-blur">
                            ...
                            <p class="mt-6 max-w-lg text-lg leading-8 text-white/90">
                                Accede para gestionar citas, servicios, horarios y la atención de tus pacientes desde un solo lugar.
                            </p>
                ...
                <div class="flex min-h-[650px] items-center justify-center bg-[var(--card)] p-6 transition-colors duration-300 sm:p-10">
                    <div class="w-full max-w-md">
                        <div class="mb-8 text-center md:text-left">
                            <Link href="/" class="mb-6 inline-flex items-center gap-3 md:hidden">
                                <img
                                    src="/assets/logo.png"
                                    alt="Dental Clinic"
                                ...
                                <div>
                                    <p class="text-xl font-black text-[var(--primary)]">
                                        Odonto
                                    </p>

                                    <p class="text-sm font-bold tracking-widest text-[var(--primary)]">
                                        Cool
                                    </p>
                                </div>
                            </Link>

                            <span class="inline-flex rounded-full bg-[var(--primary-soft)] px-5 py-2 text-sm font-bold text-[var(--primary)]">
                                Acceso al sistema
                            </span>
                        ...
                        <form class="space-y-5" @submit.prevent="submit">
                            <div>
                                ...
                                <div class="relative">
                                    <span class="pointer-events-none absolute inset-y-0 left-4 flex items-center font-bold text-[var(--primary)]">
                                        @
                                    </span>
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex cursor-pointer items-center gap-2 text-sm font-medium text-[var(--muted)]">
                                    <input
                                        v-model="form.remember"
                                        type="checkbox"
                                        class="h-4 w-4 rounded border-teal-200 text-[var(--primary)] focus:ring-[var(--primary)]"
                                    />
                        ...
                        <div class="mt-8 text-center">
                            <Link
                                href="/"
                                class="text-xl font-bold text-[var(--primary)] hover:text-[var(--primary-hover)]"
                            >
                                ← Volver al inicio
                            </Link>
